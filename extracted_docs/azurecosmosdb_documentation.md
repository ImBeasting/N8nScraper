...
**Purpose.** Interact with Azure Cosmos DB API
...
- **Icon:** `{'light': 'file:AzureCosmosDb.svg', 'dark': 'file:AzureCosmosDb.svg'}`
- **Group:** `['transform']`
- **Inputs:** `['Main']`
- **Outputs:** `['Main']`
...
- **microsoftAzureCosmosDbSharedKeyApi**: N/A
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/azureCosmosDb.json",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Azure Cosmos DB Node",
  "type": "object",
