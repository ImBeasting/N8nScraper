...
| Name | Field ID | Type | Default | Required | Description | Validation |
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| Message | `message` | string |  | ✓ | The message to send, If using Markdown add the Content Type option |  |
| Additional Fields | `additionalFields` | collection | {} | ✗ | The priority of the message | e.g. Add Field |  |
...
| ---------- | -------- | ---- | ------- | ----------- |
| Priority | `priority` | number | 1 | The priority of the message |
| Title | `title` | string |  | The title of the message |

</details>

| Options | `options` | collection | {} | ✗ | The message content type | e.g. Add option |  |
...
| Sub-Option | Field ID | Type | Default | Description |
| ---------- | -------- | ---- | ------- | ----------- |
| Content Type | `contentType` | options | text/plain | The message content type |
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/gotify.json",
