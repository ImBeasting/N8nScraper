...
version: "1"
updated: "2025-11-13"
summary: "Translate data using DeepL"
node_type: "regular"
group: "['input', 'output']"
---
...
**Purpose.** Translate data using DeepL
...
| Name | Field ID | Type | Default | Required | Description | Validation |
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| Text | `text` | string |  | ✓ | Input text to translate |  |
| Target Language Name or ID | `translateTo` | options |  | ✓ | Language to translate to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>. |  |
...
- id: translate
  ...
  - id: text
    ...
    typeInfo:
      ...
      name: text
  - id: translateTo
    name: Target Language Name or ID
    type: options
    default: ''
    required: true
    description: Language to translate to. Choose from the list, or specify an ID
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/deepL.json",
