...
**Purpose.** Throw an error in the workflow
...
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| Error Type | `errorType` | options | errorMessage | ✗ | Type of error to throw |  |
...
| Error Message | `errorMessage` | string |  | ✓ | e.g. An error occurred! |  |
| Error Object | `errorObject` | json |  | ✓ | Object containing error properties |  |
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/stopAndError.json",
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Stop and Error Node",
  "type": "object",
