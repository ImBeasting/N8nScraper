---
title: "Node: TimescaleDB"
slug: "node-timescaledb"
version: "1"
updated: "2025-11-13"
summary: "Add and update data in TimescaleDB"
node_type: "regular"
group: "['input']"
---
...
**Purpose.** Add and update data in TimescaleDB
...
| Name | Field ID | Type | Default | Required | Description | Validation |
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| Schema | `schema` | string | public | ✓ | Name of the schema the table belongs to |  |
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/timescaleDb.json",
