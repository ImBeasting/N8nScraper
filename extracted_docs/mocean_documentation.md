...
version: "1"
updated: "2025-11-13"
summary: "Send SMS and voice messages via Mocean"
node_type: "regular"
group: "['transform']"
---
...
**Purpose.** Send SMS and voice messages via Mocean
...
| Name | Field ID | Type | Default | Required | Description | Validation |
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| Operation | `operation` | options | send | ✗ | Send SMS/Voice message |  |
...
| Name | Field ID | Type | Default | Required | Description | Validation |
| ---- | -------- | ---- | ------- | :------: | ----------- | ---------- |
| From | `from` | string |  | ✓ | Number to which to send the message | e.g. Sender Number |  |
| To | `to` | string |  | ✓ | Number from which to send the message | e.g. Receipient number |  |
| Language | `language` | options | en-US | ✗ |  |  |
...
| ---------- | -------- | ---- | ------- | ----------- |
| Delivery Report URL | `dlrUrl` | string |  |  |
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/mocean.json",
