...
- **Icon:** `{'light': 'file:n8nTrainingCustomerMessenger.svg', 'dark': 'file:n8nTrainingCustomerMessenger.dark.svg'}`
- **Group:** `['transform']`
- **Inputs:** `['Main']`
- **Outputs:** `['Main']`
...
```json
{
  "$id": "https://n8n.io/schemas/nodes/n8nTrainingCustomerMessenger.json",
